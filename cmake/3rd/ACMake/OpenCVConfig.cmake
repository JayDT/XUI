...
SET(OpenCV_LIB_DIR "${OpenCV_CONFIG_PATH}/lib")
...
if(WIN32)
  foreach(__CVLIB ${OpenCV_LIB_COMPONENTS})
      ...
      if (${CMAKE_MAJOR_VERSION}.${CMAKE_MINOR_VERSION} VERSION_GREATER 2.4)
          # Modern CMake:
          SET(OpenCV_LIBS ${OpenCV_LIBS} debug ${__CVLIB}231d optimized ${__CVLIB}231)
      else()
          # Old CMake:
          SET(OpenCV_LIBS ${OpenCV_LIBS} ${__CVLIB}231)
      endif()
  endforeach()
else()
  foreach(__CVLIB ${OpenCV_LIB_COMPONENTS})
...
IF (NOT OpenCV_SHARED)
    ...
    LINK_DIRECTORIES("${OpenCV_CONFIG_PATH}/share/OpenCV/3rdparty/lib")
