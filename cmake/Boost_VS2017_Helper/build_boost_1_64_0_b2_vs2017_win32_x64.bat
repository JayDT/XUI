...
b2.exe -j8 --toolset=msvc-14.1 --clean-all
b2.exe -j8 --toolset=msvc-14.1 architecture=x86 address-model=32 --stagedir=".\stage_x86" threading=multi --build-type=complete stage
...
b2.exe -j8 --toolset=msvc-14.1 --clean-all
b2.exe -j8 --toolset=msvc-14.1 architecture=x86 address-model=64 --stagedir=".\stage_x64" threading=multi --build-type=complete stage
