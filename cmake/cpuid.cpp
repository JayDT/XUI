...
int main()
{
    ...
    int supportMask = SUPPORTS_STANDARD;
    ...
    if (HW_SSE)
        supportMask |= SUPPORTS_SSE;
    if (HW_SSE2)
        supportMask |= SUPPORTS_SSE2;
    if (HW_SSE3)
        supportMask |= SUPPORTS_SSE3;
    if (HW_SSE4a)
        supportMask |= SUPPORTS_SSE4a;
    if (HW_SSE41)
        supportMask |= SUPPORTS_SSE41;
    if (HW_SSE42)
        supportMask |= SUPPORTS_SSE42;
    if (HW_AVX)
        supportMask |= SUPPORTS_AVX1;
    if (HW_AVX2)
        supportMask |= SUPPORTS_AVX2;
