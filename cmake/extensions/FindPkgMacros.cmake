...
macro(create_search_paths PREFIX)
  ...
  endforeach(dir)
  if(ANDROID)
	set(${PREFIX}_LIB_SEARCH_PATH ${${PREFIX}_LIB_SEARCH_PATH} ${PROJECT_DEPENDENCIES_DIR}/lib/${ANDROID_ABI})
  endif()
...
macro(AddBuildInLibrary _Prefix)
    ...
    if( ${_Prefix}_USE_BUILDIN )
        ...
        MESSAGE (FATAL_ERROR "Added ${_Prefix} interface. Disabled build in mode")
    endif( ${_Prefix}_USE_BUILDIN )
endmacro(AddBuildInLibrary)