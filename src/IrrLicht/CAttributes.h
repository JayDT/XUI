...
class  IRRLICHT_API  CAttributes : public IAttributes
{
public:
    ...
    virtual bool IsMinimalSerialize() const { return isMinimalSerialize; }
    virtual void SetMinimalSerialize(bool on) { isMinimalSerialize = on;  }
