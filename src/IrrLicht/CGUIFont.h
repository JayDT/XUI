...
namespace gui
{
    ...
    struct CGUIFontCache : IGUIFontCache
    {
        scene::IMeshBuffer& GetBuffer() { return meshBuffer; }
        core::stringw& GetText() { return cachedText; }

        scene::CMeshBufferEx<video::S3DVertex> meshBuffer;
        core::stringw cachedText;
    };
...
public:
	...
	virtual void draw(const core::stringw& text, const core::rect<s32>& position,
			...
			bool vcenter=false, const core::rect<s32>* clip=0, IGUIFontCache* cache = nullptr);

	//! returns the dimension of a text
	virtual core::dimension2d<u32> getDimension(const wchar_t* text) const;

    virtual u32 BreakText(const wchar_t* text, float maxWidth, float* measuredWith = nullptr) const;

    // Inherited via IGUIFontBitmap
    virtual core::dimension2d<u32> MeasureText(const wchar_t * text, irr::core::recti & bounds) override;
    virtual core::dimension2d<u32> MeasureText(const wchar_t * text) override;
    virtual core::dimension2d<u32> MeasureText(const wchar_t * text, u32 length) override;
