...
const core::list<IGUIElement*>& CGUIPanel::getChildren() const
{
...
void CGUIPanel::serializeAttributes(io::IAttributes* out, io::SAttributeReadWriteOptions* options) const
{
