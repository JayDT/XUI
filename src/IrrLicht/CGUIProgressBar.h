...
namespace irr
{
    namespace gui
    {
        class IRRLICHT_API CGUIProgressBar : public gui::IGUIElement
        {
        public:
            /**
             * Direction
        ...
        public:
            /**
             * Constructor of CGUIProgressBar
             * @param environment
             * @param id
             */
            CGUIProgressBar(gui::IGUIElement* parent, gui::IGUIEnvironment* environment, s32 id = -1);

            /**
             * Destructor of CGUIProgressBar
             */
             ...
             * @return direction
             */
            CGUIProgressBar::Direction getDirection();
