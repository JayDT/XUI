...
namespace gui
{
	...
	class IRRLICHT_API CGUITTFont : public IGUIFont
	{
		public:
			...
			virtual void draw(const core::stringw& text, const core::rect<s32>& position,
				...
				const core::rect<s32>* clip=0, IGUIFontCache * cache = nullptr) override;

			virtual void draw(const EnrichedString& text, const core::rect<s32>& position,
				video::SColor color, bool hcenter=false, bool vcenter=false,
				const core::rect<s32>* clip=0, IGUIFontCache * cache = nullptr);
        ...
        public:
            // Inherited via IGUIFont
            virtual u32 BreakText(const wchar_t * text, float maxWidth, float * measuredWith = nullptr) const override;
