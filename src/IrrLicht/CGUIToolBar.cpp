	...
	bool useAlphaChannel)
{
    ...
    // Limit
    if (AbsoluteRect.getHeight() < rectangle.getHeight())
    {
        rectangle.LowerRightCorner.X  -= (rectangle.getHeight() - AbsoluteRect.getHeight());
        rectangle.LowerRightCorner.Y  -= (rectangle.getHeight() - AbsoluteRect.getHeight());
    }
