...
namespace gui
{
	...
	public:
        ...
        IGUITreeViewNode::NodeList::Iterator GetFirstChildren() { return Children.begin(); }
        IGUITreeViewNode::NodeList::Iterator GetLastChildren() { return Children.end(); }
	...
	private:
		...
		bool				Expanded;
        IGUITreeViewNode::NodeList Children;
        //IGUITreeViewNode::NodeList	Children;
	};
