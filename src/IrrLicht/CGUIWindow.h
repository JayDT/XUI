...
namespace gui
{
    ...
    public:
        ...
        virtual bool IsDockable() const _IRR_OVERRIDE_
        {
            return true;
        }

        virtual bool IsDocked() const _IRR_OVERRIDE_
        {
            return isDocked;
        }

        virtual bool IsCanDockHide() const _IRR_OVERRIDE_
        {
            return isCanDockHide;
        }

        virtual void CanDockHide(bool on) _IRR_OVERRIDE_
        {
            isCanDockHide = on;
        }

        virtual void setDockState(bool on, DockedElementInfo* dockInfo) _IRR_OVERRIDE_;

        virtual DockedElementInfo* getDockInfo() const _IRR_OVERRIDE_ { return DockInfo; }

        virtual void DoDragging() _IRR_OVERRIDE_;
    ...
    protected:
        ...
        core::recti OriginalWindowSize;
        core::recti ResizingRect;
        IGUIButton* CloseButton;
        IGUIButton* MinButton;
        IGUIButton* RestoreButton;
        IGUIButton* PinButton;
        IGUIButton* ResizeButton;
        DockedElementInfo* DockInfo;
        ...
        bool OnResizing : 1;
        bool isDocked : 1;
        bool isCanDockHide : 1;
        bool isMinimalized : 1;
        bool isCanBeDockedToTabControl : 1;
    };
