...
namespace irr
{
	...
	namespace gui
	{
		...
		IGUIEnvironment* createGUIEnvironment(IrrlichtDevice*, io::IFileSystem* fs,
	...
	public:
        ...
        virtual void setWorldEventReceiver(IEventReceiver* receiver);
        virtual void setConsoleEventReceiver(IEventReceiver* receiver);
        ...
        virtual void addExternalSceneManager(scene::ISceneManager* SceneManager);

        virtual void setWindowSize(const irr::core::dimension2d<u32>& size) {}
        virtual core::position2di getWindowPosition() { return core::position2di(); }
        virtual void hide() {}
        virtual void show() {}
        virtual bool isWindowMaximized() const { return false; }
        virtual irr::core::dimension2d<u32> getWindowSize() const { return irr::core::dimension2d<u32>(); }
        virtual void setWindowPosition(irr::core::position2di const& pos) {}
        virtual void invalidate(irr::core::recti const& rect) {}
        ...
        std::function<void(irr::core::dimension2du const&)> OnResizeFn;
        std::function<void()> OnCloseFn;
        std::function<void()> OnClosedFn;
        std::function<void()> OnActivatedFn;
        std::function<void()> OnDeactivatedFn;
        std::function<void(irr::core::position2di const&)> OnPositionChangedFn;
        std::function<void(irr::core::recti const&)> OnPaintFn;
