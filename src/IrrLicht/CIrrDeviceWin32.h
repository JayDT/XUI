...
namespace irr
{
	...
	public:
        ...
        virtual irr::core::dimension2d<u32> getWindowSize() const;
        virtual irr::core::dimension2d<u32> getClientSize() const;
        ...
        void setWindowSize(const irr::core::dimension2d<u32>& size);
        ...
        irr::core::vector2df GetPostionToScreen(irr::core::vector2df const&) override final;
        irr::core::vector2df GetPostionToClient(irr::core::vector2df const&) override final;
