...
namespace video
{
    ...
    public:
        ...
        // temporary
        virtual IShader* createShader(System::IO::IFileReader* vertexShader, System::IO::IFileReader* fragmentShader, System::IO::IFileReader* geometryShader, System::IO::IFileReader* tesselationShader) { return nullptr; }
        ...
        virtual void draw2DRectangle(SColor color, const core::rect<s32>& pos, const core::rect<s32>* clip = 0, bool filled = true);
        ...
        //! Creates a software image from a file.
        virtual IImage* createImageFromFile(io::IReadFile* file, void*& mipmapData);
        ...
        //! Draws a mesh buffer
        virtual void drawMeshBuffer(const scene::IMeshBuffer* mb, scene::IMesh* mesh = nullptr, scene::ISceneNode* node = nullptr);
    ...
    public:
        ...
        */
        ...
        virtual video::ITexture*  createTexture(IImage* surface, const io::path& name, void* mipmapData = 0)
        {
