...
namespace scene
{
    ...
    class  IRRLICHT_API  CSceneCollisionManager : public ISceneCollisionManager
	{
	public:
        ...
        virtual bool Intersect(G3D::Ray const& ray, scene::IIntersectionCallback* cb, ISceneNode * collisionRootNode = 0, s32 idBitMask = 0);
	...
	private:
		...
		void getPickedNodeBB(ISceneNode* root, G3D::Ray& ray, s32 bits,
