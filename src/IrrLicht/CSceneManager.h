...
namespace scene
{
	...
	*/
    class  IRRLICHT_API  CSceneManager : public ISceneManager, public ISceneNode
	{
	public:
		...
		//! gets an animateable mesh. loads it if needed. returned pointer must not be dropped.
		virtual IAnimatedMesh* getMesh(io::IReadFile* file, bool useCache = true);
        ...
        {
            mRequestToggleFreezeCulling = on;
        }

        virtual void regenerateCulling()
        {
            mNextCullingTime = 0;
        }
	...
	private:
        ...
        u32 mNextCullingTime;
        bool mRequestToggleFreezeCulling;
        bool mFreezeCulling;
        bool mRegenerateCulling;
        ...
        public:
            virtual core::array<ISceneNode*>& GetVisibleNodes() { return SkyBoxList; }
