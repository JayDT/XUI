...
namespace scene
{
	...
	class  IRRLICHT_API  CSceneNodeAnimatorCameraFPS : public ISceneNodeAnimatorCameraFPS
	{
	public:
        ...
        virtual void setVerticalMode(bool set)
        {
            NoVerticalMovement = !set;
        }

        virtual bool getVerticalMode() const { return !NoVerticalMovement; }

        virtual void setMoveSceneNode(scene::ISceneNode* node);
        virtual scene::ISceneNode* getMoveSceneNode() { return MoveNode; }

        virtual void setDevice(irr::IrrlichtDevice* device) { Device = device; }

        virtual void setPosition(const core::vector3df& newpos);

        virtual void triggerUpdate() { firstUpdate = true; }
	private:
		void allKeysUp();
		...
		bool firstUpdate : 1;
		bool firstInput : 1;
		bool NoVerticalMovement : 1;
        bool isLeftButtonPressed : 1;
        bool isHandleEvents : 1;
    };
