...
to him.
*/
class  IRRLICHT_API  CTerrainTriangleSelector : public ITriangleSelector
{
public:
    ...
    core::matrix4 const& getAbolutTransformation(u32 triangleIndex) const
    {
        static core::matrix4 tmp;
        return tmp;
    }
