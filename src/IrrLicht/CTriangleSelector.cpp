...
core::matrix4 const& CTriangleSelector::getAbolutTransformation(u32 triangleIndex) const
{ 
    return getSceneNodeForTriangle(triangleIndex)->getAbsoluteTransformation();
}
