...
public:
	...
	struct  IRRLICHT_API  SMeshChunk : public scene::CMeshBuffer<T>
	{
		SMeshChunk ()
        ...
        //SMeshChunk(const SMeshChunk&) = default;
        //SMeshChunk& operator=(const SMeshChunk&) = default;

        //SMeshChunk(SMeshChunk const& copy) : scene::CMeshBuffer<T>(copy)
        //{
        ...
        //SMeshChunk& operator=(SMeshChunk const& copy) = default;

        //SMeshChunk& operator=(SMeshChunk const& copy)
        //{
        //    scene::CMeshBuffer<T>::operator=((scene::CMeshBuffer<T> const&)copy);
        //    MaterialId = copy.MaterialId;
        //}
