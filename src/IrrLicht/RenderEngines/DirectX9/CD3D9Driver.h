...
namespace video
{
	...
	public:
		...
		bool updateIndexHardwareBuffer(CD3D9HardwareBuffer *HWBuffer);
	...
	private:
        ...
        core::array<D3DVERTEXELEMENT9> VertexDeclarationMap[EVT_MAX_VERTEX_TYPE];
        LPDIRECT3DVERTEXDECLARATION9 VertexDeclaration[EVT_MAX_VERTEX_TYPE];
