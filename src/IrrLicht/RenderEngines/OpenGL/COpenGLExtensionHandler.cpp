...
COpenGLExtensionHandler::COpenGLExtensionHandler() :
	...
	pGlGetActiveUniformARB(0), pGlGetActiveUniform(0), pGLGetActiveUniformSiv(0), pGLGetUniformIndices(0),
	...
	pGlGenBuffersARB(0), pGlBindBufferARB(0), pGlBufferDataARB(0), pGlDeleteBuffersARB(0), pGlDeleteVertexArrays(0),
    ...
    pGlBlendEquationEXT(0), pGlBlendEquation(0), pGLDrawRangeElements(0),
    pGLGenVertexArray(0), pGLBindVertexArray(0), pGLDisableVertexAttribArray(0), pGLEnableVertexAttribArray(0),
    pGLDrawRangeElementsBaseVertex(0), pGLDrawElementsBaseVertex(0), pGLTexBufferArb(0), pGLValidateProgram(0),
    pGLDrawElementsInstanced(0), pGLVertexAttribPointer(0), pGLVertexAttribIPointer(0)
...
void COpenGLExtensionHandler::initExtensions(bool stencilBuffer)
{
    ...
    pGLDrawRangeElements = (PFNGLDRAWRANGEELEMENTSPROC) IRR_OGL_LOAD_EXTENSION("glDrawRangeElements");
    pGLGenVertexArray = (PFNGLGENVERTEXARRAYSPROC) IRR_OGL_LOAD_EXTENSION("glGenVertexArrays");
    ...
    pGLDrawElementsBaseVertex = (PFNGLDRAWELEMENTSBASEVERTEXPROC)IRR_OGL_LOAD_EXTENSION("glDrawElementsBaseVertex");
    pGLDrawRangeElementsBaseVertex = (PFNGLDRAWRANGEELEMENTSBASEVERTEXPROC)IRR_OGL_LOAD_EXTENSION("glDrawRangeElementsBaseVertex");
    pGLTexBufferArb = (PFNGLTEXBUFFERARBPROC)IRR_OGL_LOAD_EXTENSION("glTexBufferARB");
    pGLValidateProgram = (PFNGLVALIDATEPROGRAMPROC)IRR_OGL_LOAD_EXTENSION("glValidateProgram");
    pGLVertexAttribPointer = (PFNGLVERTEXATTRIBPOINTERPROC)IRR_OGL_LOAD_EXTENSION("glVertexAttribPointer");
    pGLVertexAttribIPointer = (PFNGLVERTEXATTRIBIPOINTERPROC)IRR_OGL_LOAD_EXTENSION("glVertexAttribIPointer");
...
#endif
		MaxSupportedTextures=core::min_((u8)MATERIAL_MAX_TEXTURES, static_cast<u8>(num));
	}
#endif
