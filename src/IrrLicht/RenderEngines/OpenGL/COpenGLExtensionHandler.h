...
namespace irr
{
    namespace video
    {
        ...
        public:
            ...
            void extGlGetActiveUniformSiv(GLuint program, GLsizei uniformCount, const GLuint *uniformIndices, GLenum pname, GLint *params);
            void extGlGetUniformIndicies(GLuint program, GLsizei uniformCount, const GLchar** uniformNames, GLuint* uniformIndices);
            ...
            void extGlDeleteVertexArrays(GLsizei n, const GLuint *buffers);
            ...
            void extGLDisableVertexAttribArray(GLuint array);
            void extGLEnableVertexAttribArray(GLuint array);
            ...
            void extGLTexBufferARB(GLenum target, GLenum internalformat, GLuint buffer);
            void extGLValidateProgram(GLuint program);
            ...
            void extGLVertexAttribIPointer(GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid* pointer);
        ...
        protected:
            ...
            PFNGLGENVERTEXARRAYSPROC pGLGenVertexArray;
            ...
            PFNGLTEXBUFFERARBPROC pGLTexBufferArb;
        ...
        inline void COpenGLExtensionHandler::extGlGetUniformIndicies(GLuint program, GLsizei uniformCount, const GLchar** uniformNames, GLuint* uniformIndices)
        {
#ifdef _IRR_OPENGL_USE_EXTPOINTER_
            if (pGLGetUniformIndices)
        ...
        inline void COpenGLExtensionHandler::extGlGetActiveUniformSiv(GLuint program, GLsizei uniformCount, const GLuint *uniformIndices, GLenum pname, GLint *params)
        {
#ifdef _IRR_OPENGL_USE_EXTPOINTER_
            if (pGLGetActiveUniformSiv)
        ...
        inline void COpenGLExtensionHandler::extGlDeleteVertexArrays(GLsizei n, const GLuint *buffers)
        {
#ifdef _IRR_OPENGL_USE_EXTPOINTER_
            if (pGlDeleteVertexArrays)
                pGlDeleteVertexArrays(n, buffers);
#elif defined(GL_ARB_vertex_buffer_object)
    ...
    // does not work with interval==0
        ...
        inline void COpenGLExtensionHandler::extGLDrawRangeElements(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid *indices)
        {
#ifdef _IRR_OPENGL_USE_EXTPOINTER_
            if (pGLDrawRangeElements)
                pGLDrawRangeElements(mode, start, end, count, type, indices);
            else
                os::Printer::log("glDrawRangeElements not supported", ELL_ERROR);
#endif
        }

        inline void COpenGLExtensionHandler::extGLEnableVertexAttribArray(GLuint array)
        {
#ifdef _IRR_OPENGL_USE_EXTPOINTER_
            if (pGLEnableVertexAttribArray)
                pGLEnableVertexAttribArray(array);
            else
                os::Printer::log("glBindVertexArray not supported", ELL_ERROR);
#endif
        }

        inline void COpenGLExtensionHandler::extGLDisableVertexAttribArray(GLuint array)
        {
#ifdef _IRR_OPENGL_USE_EXTPOINTER_
            if (pGLDisableVertexAttribArray)
                pGLDisableVertexAttribArray(array);
            else
                os::Printer::log("glBindVertexArray not supported", ELL_ERROR);
#endif
        }

        inline void COpenGLExtensionHandler::extGLDrawElementsBaseVertex(GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLint basevertex)
        {
#ifdef _IRR_OPENGL_USE_EXTPOINTER_
            if (pGLDrawElementsBaseVertex)
                pGLDrawElementsBaseVertex(mode, count, type, (GLvoid*)indices, basevertex);
            else
                os::Printer::log("glDrawRangeElements not supported", ELL_ERROR);
#endif
        }

        inline void COpenGLExtensionHandler::extGLDrawRangeElementsBaseVertex(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid *indices, GLint basevertex)
        {
#ifdef _IRR_OPENGL_USE_EXTPOINTER_
            if (pGLDrawRangeElementsBaseVertex)
                pGLDrawRangeElementsBaseVertex(mode, start, end, count, type, (GLvoid*)indices, basevertex);
            else
                os::Printer::log("glDrawRangeElements not supported", ELL_ERROR);
#endif
        }

        inline void COpenGLExtensionHandler::extGLTexBufferARB(GLenum target, GLenum internalformat, GLuint buffer)
        {
#ifdef _IRR_OPENGL_USE_EXTPOINTER_
            if (pGLTexBufferArb)
                pGLTexBufferArb(target, internalformat, buffer);
            else
                os::Printer::log("pGLTexBufferArb not supported", ELL_ERROR);
#endif
        }

        inline void COpenGLExtensionHandler::extGLValidateProgram(GLuint program)
        {
#ifdef _IRR_OPENGL_USE_EXTPOINTER_
            if (pGLValidateProgram)
        ...
        inline void COpenGLExtensionHandler::extGLVertexAttribIPointer(GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid* pointer)
        {
#ifdef _IRR_OPENGL_USE_EXTPOINTER_
            if (pGLVertexAttribIPointer)
        ...
        inline void COpenGLExtensionHandler::extGLDrawElementsInstanced(GLenum type, GLsizei icount, GLenum isize, const GLvoid* istart, GLsizei instanceNum)
        {
#ifdef _IRR_OPENGL_USE_EXTPOINTER_
            if (pGLDrawElementsInstanced)
                pGLDrawElementsInstanced(type, icount, isize, istart, instanceNum);
            else
                os::Printer::log("pGLTexBufferArb not supported", ELL_ERROR);
#endif
        }
        ...
        inline void COpenGLExtensionHandler::extGLGenVertexArray(GLsizei n, GLuint *arrays)
        {
#ifdef _IRR_OPENGL_USE_EXTPOINTER_
            if (pGLGenVertexArray)
                pGLGenVertexArray(n, arrays);
            else
                os::Printer::log("glGenVertexArrays not supported", ELL_ERROR);
#endif
        }

        inline void COpenGLExtensionHandler::extGLBindVertexArray(GLuint array)
        {
#ifdef _IRR_OPENGL_USE_EXTPOINTER_
