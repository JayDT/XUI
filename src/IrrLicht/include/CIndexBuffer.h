...
namespace scene
{
	...
	class IRRLICHT_API CIndexBuffer : public IIndexBuffer
	{

		class IRRLICHT_API IIndexList
		{
		public:
			virtual ~IIndexList(){};
        ...
        public:
		template <class T>
		class IRRLICHT_API CSpecificIndexList : public IIndexList
		{
		public:
	...
	public:
        ...
        virtual void operator ()(const u32 index, const u32 element) const
        {
            Indices->setValue(index, element);
        }
		...
		E_HARDWARE_MAPPING MappingHint : 8;
		u32 ChangedID;
	};
