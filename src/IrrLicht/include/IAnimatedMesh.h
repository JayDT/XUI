...
namespace scene
{
	...
	class  IRRLICHT_API  IAnimatedMesh : public IMesh
	{
	public:
        ...
        virtual IAnimatedMesh* GetChildMesh(u32 id) { return nullptr; }
        ...
        virtual IAnimatedMesh* toIAnimateMesh() _IRR_OVERRIDE_ { return this; }

        virtual void RenderAttachements(core::matrix4& parentWorldView) {}

        // return true can be continue false break execution
        virtual bool OnAnimateEndFrame()
        {
            return true;
        }
	};
