...
class IRRLICHT_API IAttributes : public virtual IReferenceCounted
{
public:
	...
	*/
    ...
    virtual bool IsMinimalSerialize() const { return false; }
    virtual void SetMinimalSerialize(bool) {  }
};
