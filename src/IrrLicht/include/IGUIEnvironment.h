...
namespace irr
{
    ...
    namespace core
	{
        template <class T, typename TAlloc > class array;
    }
...
*/
class IRRLICHT_API IGUIEnvironment : public virtual IReferenceCounted
{
public:
    virtual void showDockIcons(bool on) = 0;
    virtual void DockGUIElement(E_WINDOW_DOCK_TYPE dockType, IGUIElement* guielement) = 0;
    virtual bool DockByPoint(const core::position2d<s32>& point, IGUIElement* dockElement) = 0;
	...
	*/
	...
	This pointer should not be dropped. See IReferenceCounted::drop() for
	more information. */
	virtual IGUIFont* getFont(const io::path& filename, s32 fontSize = -1, bool UseFreeTypeFont = false) = 0;
    ...
    virtual IGUIEditBox* addCodeEditBox(const wchar_t* text, const core::rect<s32>& rectangle, bool border, bool lines,
        IGUIElement* parent = 0, s32 id = -1, IrrlichtDevice* Device = nullptr) = 0;
	...
	\param start The GUIElement to start with. Root if 0.
	\return True if saving succeeded, else false. */
	virtual bool saveGUI(io::IWriteFile* file, IGUIElement* start=0, bool isMinimalSerialize = false, bool withChildrens = true) = 0;
	...
	virtual bool loadGUI(const io::path& filename, IGUIElement* parent=0, core::array<gui::IGUIElement*, core::irrAllocator<gui::IGUIElement*> >* loaded = nullptr) = 0;
	...
	\param parent Parent for the loaded GUI, root if 0.
	\return True if loading succeeded, else false. */
	virtual bool loadGUI(io::IReadFile* file, IGUIElement* parent=0, core::array<gui::IGUIElement*, core::irrAllocator<gui::IGUIElement*> >* loaded = nullptr, IGUIElement* element = nullptr) = 0;
	...
	//! writes an element
	virtual void writeGUIElement(io::IXMLWriter* writer, IGUIElement* node, bool isMinimalSerialize = false, bool withChildrens = true) =0;

	//! reads an element
	virtual void readGUIElement(io::IXMLReader* reader, IGUIElement* node, core::array<gui::IGUIElement*, core::irrAllocator<gui::IGUIElement*> >* loaded = nullptr, IGUIElement* element = nullptr) =0;
	...
	*/
    ...
    virtual void DisposeElement(gui::IGUIElement* element) = 0;
    virtual void DisposeForm(irr::Forms::IForm* element) = 0;
};
