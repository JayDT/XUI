...
public:
    ...
    //! Returns the array of animated rects within the sprite bank
    virtual core::array< core::rect<s32> >& getRectangles() = 0;
    ...
    virtual bool CacheGeometry(scene::IMeshBuffer& meshBuffer, const core::array<u32>& indices, const core::array<core::position2di>& pos,
        const core::rect<s32>* clip = 0,
        const video::SColor& color = video::SColor(255, 255, 255, 255),
        u32 starttime = 0, u32 currenttime = 0,
        bool loop = true, bool center = false) = 0;
