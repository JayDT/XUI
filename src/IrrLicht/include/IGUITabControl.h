...
namespace gui
{
    ...
    public:
        ...
        */
        ...
        // Internal use (protection later)
        virtual void setNumber(s32 n) = 0;
        ...
        virtual void refreshSkinColors() = 0;
    ...
    */
    ...
    public:
        ...
        virtual void setCanNewWindow(bool on) = 0;
    };
