...
namespace gui
{
	...
	*/
	...
	class IGUITreeViewNode : public IReferenceCounted, public System::Collection::LinkedListElement
	{
	public:
        typedef System::Collection::LinkedListHead<IGUITreeViewNode> NodeList;
		...
		*/
        ...
        virtual IGUITreeViewNode::NodeList::Iterator GetFirstChildren() = 0;
        virtual IGUITreeViewNode::NodeList::Iterator GetLastChildren() = 0;
	};
