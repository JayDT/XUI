...
namespace scene
{
    ...
    enum E_SCENE_NODE_RENDER_PASS : uint32
    {
        ...
        ESNRP_INSTANCE = 256,
        ESNRP_INSTANCE_TRANSPARENT = 512,

        ESNRP_FIRST_STAGE = 1024,

        ESNRP_SKIP_CULL = 0x800,
        ESNRP_3D_TEXT = 0x1000,
    };
    ...
    */
    class IRRLICHT_API ISceneManager : public virtual IReferenceCounted
    {
    public:
        ...
        virtual IAnimatedMesh* getMesh(io::IReadFile* file, bool useCache = true) = 0;
        ...
        */
        ...
        virtual void RegisterAsyncInitializer(void* ptr, u32 type) {}
        ...
        */
        ...
        virtual core::array<core::matrix4> const* getInstanceData() const { return nullptr; }
        ...
        virtual void freezeCulling(bool on) {}

        virtual u32 getEnabledFlags() const { return 0; }
        virtual u32 setEnabledFlags(u32 flag, bool on) { return 0; }
