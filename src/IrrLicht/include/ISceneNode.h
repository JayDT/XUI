...
namespace scene
{
    ...
    */
    class IRRLICHT_API ISceneNode : virtual public io::IAttributeExchangingObject
    {
    public:
        ...
        */
        ...
        virtual void renderInstance(void* instanceInfo) {}

        void setOcculisionQuery(video::SOccQuery* _OccQuery)
        {
            //OccQuery = _OccQuery;
        }

        video::SOccQuery* getOcculisionQuery() const
        {
            return nullptr; // OccQuery;
        }
        ...
        {
            return AbsoluteTransformationBoundingBox;
        }
        ...
        */
        ...
        virtual void OnJumpOrCrouch(ISceneNodeAnimatorCameraFPS* animator, bool Ascend)
        {
            
        }

        virtual void OnMove(ISceneNodeAnimatorCameraFPS* animator, const core::vector3df& newpos, const core::vector3df& newrot, u32 /*moveFlags*/)
        {
            setPosition(newpos);
            setRotation(newrot);
            updateAbsolutePosition();
        ...
        virtual void OnIdle(ISceneNodeAnimatorCameraFPS* animator, const core::vector3df& /*newpos*/, const core::vector3df& /*newrot*/, u32 /*moveFlags*/)
        {
            
        }

        virtual void OnRelocate(const core::vector3df& newpos, const core::vector3df& newrot, u32 /*Flags*/)
        {
            setPosition(newpos);
            setRotation(newrot);
            updateAbsolutePosition();
        ...
        virtual float GetFloatData(u32 type) { return 0.f; }
        ...
        {
            return nullptr; // TriangleSelector;
        }
        ...
        //! Updates the absolute position based on the relative and the parents position
        virtual void updateAbsolutePositionEx()
        {
            updateAbsolutePosition();

            ISceneNodeList::iterator it = Children.begin();
            for (; it != Children.end(); ++it)
                (*it)->updateAbsolutePositionEx();
        }

        void SetAbsoluteMatrix(core::matrix4& m)
        {
    ...
    protected:
        ...
        core::aabbox3d<f32> AbsoluteTransformationBoundingBox;
