...
namespace scene
{
	...
	*/
	class IRRLICHT_API ISceneNodeAnimatorCameraFPS : public ISceneNodeAnimator
	{
	public:
        ...
        virtual void setVerticalMode(bool set) = 0;
        virtual bool getVerticalMode() const = 0;
        virtual void setMoveSceneNode(scene::ISceneNode* node) = 0;
        virtual scene::ISceneNode* getMoveSceneNode() = 0;
