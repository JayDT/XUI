...
class IRRLICHT_API ITriangleSelector : public virtual IReferenceCounted
{
public:
    ...
    virtual void getRawTriangles(core::triangle3df* triangles, s32 arraySize,
        s32& outTriangleCount, const core::line3d<f32>& line) const
    {
        triangles = nullptr;
    }
    ...
    */
    ...
    virtual core::matrix4 const& getAbolutTransformation(u32 triangleIndex) const = 0;
    ...
    */
    ...
    virtual bool IntersectWithRay(G3D::Ray const& ray, float& distance) { return false; }
};
