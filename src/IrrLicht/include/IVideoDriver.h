...
namespace video
{
	...
	*/
    class IRRLICHT_API IVideoDriver : public virtual IReferenceCounted
	{
	public:
		...
		*/
        ...
        virtual video::ITexture*  createTexture(IImage* surface, const io::path& name, void* mipmapData = 0) = 0;
        ...
        //! Draws an indexed triangle strip.
        /** Note that there may be at maximum 65536 vertices, because
        the index list is an array of 16 bit values each with a maximum
        value of 65536. If there are more than 65536 vertices in the
        list, results of this operation are not defined.
        ...
        \param indexList Pointer to array of indices.
        \param triangleCount Amount of Triangles. Usually amount of indices - 2. */
        void drawIndexedTriangleStrip(const S3DVertex* vertices,
            u32 vertexCount, const u16* indexList, u32 triangleCount)
        {
            drawVertexPrimitiveList(vertices, vertexCount, indexList, triangleCount - 2, EVT_STANDARD, scene::EPT_TRIANGLE_STRIP, EIT_16BIT);
        }
		...
		virtual void draw2DRectangle(SColor color, const core::rect<s32>& pos,
			const core::rect<s32>* clip =0, bool filled = true) =0;
		...
		*/
		...
		virtual void drawMeshBuffer(const scene::IMeshBuffer* mb, scene::IMesh* mesh = nullptr, scene::ISceneNode* node = nullptr) =0;
        virtual void drawMeshBuffer3DBox(const scene::IMeshBuffer* mb) = 0;
		...
		*/
        ...
        virtual void CreateHardwareBuffer(const scene::IMeshBuffer* mb) =0;

        virtual bool activeGPUProgram(IShader* gpuProrgam) = 0;
        virtual IShader* getActiveGPUProgram() = 0;
