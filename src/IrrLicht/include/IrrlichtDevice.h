...
namespace irr
{
	...
	time.
	*/
	class IRRLICHT_API IrrlichtDevice : public virtual IReferenceCounted
	{
	public:
		...
		*/
        ...
        virtual void setWorldEventReceiver(IEventReceiver* receiver) = 0;
        virtual void setConsoleEventReceiver(IEventReceiver* receiver) = 0;
		...
		*/
        ...
        virtual irr::core::vector2df GetPostionToClient(irr::core::vector2df const&)
        {
            return irr::core::vector2df();
        }
};
    ...
    extern "C" IRRLICHT_API bool isDriverSupported(video::E_DRIVER_TYPE driver);
