...
struct SSkinMeshBuffer : public IMeshBuffer
{
    ...
    virtual video::S3DVertex& operator[](int idx)
    {
        ...
        {
        case video::EVT_2TCOORDS:
            return Vertices_2TCoords[idx];
        case video::EVT_TANGENTS:
            return Vertices_Tangents[idx];
        default:
            return Vertices_Standard[idx];
        }
    }
	...
	virtual void boundingBoxNeedsRecalculated(void) { BoundingBoxNeedsRecalculated = true; }
