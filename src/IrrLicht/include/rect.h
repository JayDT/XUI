...
namespace core
{
	...
	*/
	...
	public:
        ...
        //! move right by given numbers
        rect<T>& operator+(const rect<T>& pos)
        {
            rect<T> ret(*this);
            ret.UpperLeftCorner += pos.UpperLeftCorner;
            ret.LowerRightCorner += pos.LowerRightCorner;
            return ret;
        }
        ...
        rect<T>& operator+=(const rect<T>& pos)
        {
            UpperLeftCorner += pos.UpperLeftCorner;
            LowerRightCorner += pos.LowerRightCorner;
            return *this;
        }
