...
irr::u32 readFlagString(std::string str, const FlagDesc *flagdesc, irr::u32 *flagmask);
std::string writeFlagString(irr::u32 flags, const FlagDesc *flagdesc, irr::u32 flagmask);
size_t mystrlcpy(char *dst, const char *src, size_t size);
char *mystrtok_r(char *s, const char *sep, char **lasts);
irr::u64 read_seed(const char *str);
 ...
 */
inline irr::s32 mystoi(const std::string &str, irr::s32 min, irr::s32 max)
{
    irr::s32 i = atoi(str.c_str());
 ...
 */
inline irr::s32 mystoi(const std::string &str)
{
 ...
 * @see atoi(3) for further limitations
 */
inline irr::s32 mystoi(const std::wstring &str)
{
...
inline irr::s64 stoi64(const std::string &str) { return from_string<irr::s64>(str); }
...
inline std::string itos(irr::s32 i) { return std::to_string(i); }
/// Returns a string representing the decimal value of the 64-bit value \p i.
inline std::string i64tos(irr::s64 i) { return std::to_string(i); }
