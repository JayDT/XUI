...
namespace System::Reflection
{
    inline namespace meta
    {
        ...
        class TC_METARUNTIME_API FieldGetterBase : public IMethod
        {
        public:
            ...
            virtual Variant GetValue(uint32_t uid, const Variant &obj) = 0;
            virtual Variant GetValueReference(uint32_t uid, const Variant &obj) = 0;
