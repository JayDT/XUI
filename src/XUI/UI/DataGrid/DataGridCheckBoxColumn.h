...
#ifndef __XUI_UI_DATACOLUMN_CHECKBOX_H__
#define __XUI_UI_DATACOLUMN_CHECKBOX_H__
...
namespace XUI::UI
{
    class DataGridCheckBoxColumn : public DataGridColumn
    {
    public:
        ...
        virtual ~DataGridCheckBoxColumn();

        DEPENDENCY_PROPERTY_(bool, IsThreeState)
        ...
        void CheckBoxPointerPress(void* x, Interfaces::PointerPressedEventArgs& e);
...
#endif //!__XUI_UI_DATACOLUMN_CHECKBOX_H__