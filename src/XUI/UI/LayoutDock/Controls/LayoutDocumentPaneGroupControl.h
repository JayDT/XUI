...
#ifndef __XUI_UI_LAYOUT_DOCK_LAYOUT_DOCUMENT_PANE_GROUP_CONTROL_H__
#define __XUI_UI_LAYOUT_DOCK_LAYOUT_DOCUMENT_PANE_GROUP_CONTROL_H__
...
namespace XUI::UI
{
    class LayoutDocumentPaneGroupControl : public LayoutGridControl //<LayoutDocumentPane>
    {
    private:
    ...
    public:
        ...
        LayoutDocumentPaneGroupControl(LayoutDocumentPaneGroup* model);
        virtual ~LayoutDocumentPaneGroupControl();
