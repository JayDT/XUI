...
#ifndef __XAMLCPP_NULLEXTENSION_H__
#define __XAMLCPP_NULLEXTENSION_H__
...
{
    class NullExtension : public Interfaces::IMarkupExtension
    {

    public:
        NullExtension() {}
        virtual ~NullExtension() {}
...
#endif	//#ifndef __XAMLCPP_NULLEXTENSION_H__
